    ...
    Tables: {
      analysis_runs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "analysis_runs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
      ...
      birthday_cluster_actions: {
        ...
        Relationships: [
          {
            foreignKeyName: "birthday_cluster_actions_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      data_profiles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "data_profiles_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      import_staging: {
        ...
        Relationships: [
          {
            foreignKeyName: "import_staging_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      import_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "import_templates_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      scoring_snapshots: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "scoring_snapshots_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      strategy_validations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "strategy_validations_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
